...
static int rfuse_queue_request(struct rfuse_req *r_req)
{
	...
	idle_waitqueue_active = waitqueue_active(&riq->idle_user_waitq);
	rfuse_enqueue_waitqueue_record(r_req, idle_waitqueue_active);
